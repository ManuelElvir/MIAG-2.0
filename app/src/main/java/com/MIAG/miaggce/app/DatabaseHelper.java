...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_QUESTION = "create table " + QUESTION + "( QUEST_ID INTEGER PRIMARY KEY, QUEST_LABEL  TEXT, PAPER1_ID INTEGER, TUTO_ID INTEGER);";
    ...
    private static final String CREATE_TABLE_ANWSER = "create table " + ANWSER + "( ANWS_ID INTEGER PRIMARY KEY AUTOINCREMENT, ANWS_CONTENT  TEXT, ANWS_STATE INTEGER, QUEST_ID INTEGER);";
