...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_QUESTION = "create table " + QUESTION + "( QUEST_ID INTEGER PRIMARY KEY, QUEST_LABEL  TEXT, PAPER1_ID INTEGER, CHAP_ID INTEGER);";
