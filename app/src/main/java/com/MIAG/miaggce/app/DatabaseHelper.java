...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_PAPER1 = "create table " + PAPER1 + "( PAPER1_ID INTEGER PRIMARY KEY, QCM_ID INTEGER, TEST_ID INTEGER, TEST_NAME TEXT NOT NULL, TEST_CHRONO TEXT, TEST_DATE TEXT, SJ_ID INTEGER);";
    private static final String CREATE_TABLE_PAPER2 = "create table " + PAPER2 + "( PAPER2_ID INTEGER PRIMARY KEY, TEST_ID INTEGER, TEST_NAME TEXT NOT NULL, TEST_CHRONO TEXT, TEST_DATE TEXT, TEST_CONTENT TEXT, SJ_ID INTEGER);";
    private static final String CREATE_TABLE_PAPER3 = "create table " + PAPER3 + "( PAPER3_ID INTEGER PRIMARY KEY, TEST_ID INTEGER, TEST_NAME TEXT NOT NULL, TEST_CHRONO TEXT, TEST_DATE TEXT, TEST_CONTENT TEXT, SJ_ID INTEGER);";
    ...
    private static final String CREATE_TABLE_REQUIEREMENT = "create table " + REQUIEREMENT + "( REQ_ID INTEGER PRIMARY KEY, COMP_ID INTEGER, REQ_NAME TEXT NOT NULL, REQ_FILE TEXT, REQ_CONTENT TEXT, REQ_URL TEXT, REQ_DATE TEXT);";
    ...
    private static final String CREATE_TABLE_ANWSER = "create table " + ANWSER + "( ANWS_ID INTEGER PRIMARY KEY, ANWS_CONTENT  TEXT NOT NULL, ANWS_DATE TEXT, ANWS_STATE INTEGER, QUEST_ID INTEGER);";
