...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_BLOC_NOTE = "create table " + BLOC_NOTE + "( NOTE_ID INTEGER PRIMARY KEY, USER_ID INTEGER, NOTE_CONTENT TEXT, NOTE_COLOR INT, NOTE_DATE TEXT);";
